...
namespace ImportServiceCore.DTO
{
    ...
    class PbComparer : IEqualityComparer<Model.Pannebakker>
    {
        // Products are equal if their names and product numbers are equal.
        public bool Equals(Model.Pannebakker x, Model.Pannebakker y)
        {
        ...
        public int GetHashCode(Model.Pannebakker product)
        {
