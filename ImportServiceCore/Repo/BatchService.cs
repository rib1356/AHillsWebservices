...
{
    public class BatchService : IBatchRep
    {
        ...
        public DTO.BatchDTO GetBatchItem(int id)
        {
            System.Net.Http.HttpClient client = ApiClient();
        ...
        public IEnumerable<DTO.BatchDTO> GetBatches()
        {
        ...
        public IEnumerable<DTO.LocationDTO> GetLocations()
        {
        ...
        public IEnumerable<DTO.LocationDTO> GetSubLocations(String main)
        {
        ...
        private IEnumerable<DTO.LocationDTO> GetLocationsFromervice(HttpClient client)
        {
